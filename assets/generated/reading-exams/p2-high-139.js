  ...
  "questionGroups": [
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q1-2-3-4-anchor\">\n                 <h4>Questions 14–17</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion\">\n                    <h4>Malaria in 19th-century Italy</h4>\n                    <p>\n                    Up until the late nineteenth century, experts failed to make the connection between malaria and <strong>14</strong> <input type=\"text\" id=\"q14_input\">. The most popular belief at the time was the <strong>15</strong> <input type=\"text\" id=\"q15_input\"> theory, which upheld the idea that diseases were carried by unclean air. Another common idea was that malaria was a <strong>16</strong> <input type=\"text\" id=\"q16_input\"> disease, and as a result people from certain parts of the country were often held responsible for the spread of epidemics. Malaria was particularly widespread in rural regions, where <strong>17</strong> <input type=\"text\" id=\"q17_input\"> could be extremely short.\n                    </p>\n                </div>\n            </div>",
