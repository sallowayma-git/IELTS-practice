(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-12-13-anchor\">\n                 <h4>Questions 24–26</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion\">\n                    <h4>Seeking comfort in city living</h4>\n                    <p>\n                    It's not only native plants and animals that are adapting to city life; non-native plants and animals are also adapting. Examples of successful ‘city dwellers' include small, non-native rats and non-native insects such as <strong>24</strong> <input type=\"text\" id=\"q24_input\">. However, what causes most problems in the city is weeds. Michelle Leishman, a scientist from Macquarie University, has proven that Sydney's large areas of <strong>25</strong> <input type=\"text\" id=\"q25_input\"> and its drainage network favour the growth of weeds. Water gathers <strong>26</strong> <input type=\"text\" id=\"q26_input\"> as it passes from gardens and streets into the city drainage network. This, in turn, creates very good soil for several varieties of rapidly growing non-native plants.\n                    </p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "vi",
  ...
  "audit": {
    "matchStatus": "matched",
    "matchConfidence": 1,
    "verifiedAt": "2026-03-08T16:24:30.746Z",
