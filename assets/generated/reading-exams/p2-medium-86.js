(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-12-13-anchor\">\n                 <h4>Questions 24–26</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion\">\n                    <p>\n                    In the middle of the new park is a <strong>24</strong> <input type=\"text\" id=\"q24_input\">, where there is a path for pedestrians and two railway lines. A slow train uses these lines to make a regular journey between its base and a <strong>25</strong> <input type=\"text\" id=\"q25_input\">. Benches have been provided on the north side, so that people can relax and enjoy the sunshine, and to the east is an area with mature trees of various kinds, as well as sets of swings. A range of sports and leisure areas are situated around the <strong>26</strong> <input type=\"text\" id=\"q26_input\"> of the site.\n                    </p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "iv",
