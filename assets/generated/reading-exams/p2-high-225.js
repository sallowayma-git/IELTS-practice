(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "kind": "multi_choice",
      "questionIds": ["q6", "q7"],
      "bodyHtml": "<div class=\"group\" id=\"q6-7-anchor\">\n<h4>Questions 19 and 20</h4>\n<p>Choose <strong>TWO</strong> letters, A-E.</p>\n<p>The article gives details about different methods of removing graffiti.</p>\n<p>Which <strong>TWO</strong> points are made by the writer of this article?</p>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q6_7\" value=\"A\"> A Chemicals are an expensive method of removing graffiti from surfaces.</label></div>\n</div>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q6_7\" value=\"B\"> B An inconspicuous part of a surface should be used to test a cleaning method.</label></div>\n</div>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q6_7\" value=\"C\"> C Alcohol-based chemical preparations are often successful at removing graffiti.</label></div>\n</div>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q6_7\" value=\"D\"> D Localised pollution can result from some cleaning methods.</label></div>\n</div>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q6_7\" value=\"E\"> E It is best to use the strongest available cleaning method.</label></div>\n</div>\n</div>"
    },
    {
      "groupId": "group-3",
      "kind": "multi_choice",
      "questionIds": ["q8", "q9"],
      "bodyHtml": "<div class=\"group\" id=\"q8-9-anchor\">\n<h4>Questions 21 and 22</h4>\n<p>Choose <strong>TWO</strong> letters, A-E.</p>\n<p>The writer describes ways of combating a recurring problem of graffiti.</p>\n<p>Which <strong>TWO</strong> of these ideas are mentioned by the writer?</p>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q8_9\" value=\"A\"> A Running advertising campaigns against graffiti</label></div>\n</div>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q8_9\" value=\"B\"> B Creating a new building material that repels graffiti</label></div>\n</div>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q8_9\" value=\"C\"> C Hiring security guards and increasing police patrols</label></div>\n</div>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q8_9\" value=\"D\"> D Ensuring surfaces are visible and monitored both day and night</label></div>\n</div>\n<div class=\"choice-item\">\n<div class=\"choice-item\"><label><input type=\"checkbox\" name=\"q8_9\" value=\"E\"> E Adding a covering layer that graffiti cannot penetrate</label></div>\n</div>\n</div>"
    },
    {
      "groupId": "group-4",
      "kind": "short_answer",
