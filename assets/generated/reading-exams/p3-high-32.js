(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-12-13-14-anchor\">\n                <h4>Questions 37–40</h4>\n                <p>Complete the summary using the list of words, <strong>A–I</strong>, below.</p>\n                <div class=\"summary-box\">\n                    <h5>The work of Marschner and his colleagues</h5>\n                    <p>\n                    For many years, CGI characters did not appear entirely lifelike as their skin appeared plastic. Marschner and his colleagues were the first to apply an understanding of how <strong>37</strong> \n                    <select id=\"q37_select\"><option value=\"\">...</option><option value=\"A\">A</option><option value=\"B\">B</option><option value=\"C\">C</option><option value=\"D\">D</option><option value=\"E\">E</option><option value=\"F\">F</option><option value=\"G\">G</option><option value=\"H\">H</option><option value=\"I\">I</option></select>\n                     interacts with human skin. Their CGI model is based on a novel application of principles of <strong>38</strong> \n                     <select id=\"q38_select\"><option value=\"\">...</option><option value=\"A\">A</option><option value=\"B\">B</option><option value=\"C\">C</option><option value=\"D\">D</option><option value=\"E\">E</option><option value=\"F\">F</option><option value=\"G\">G</option><option value=\"H\">H</option><option value=\"I\">I</option></select>\n                     , which had previously been applied in other scientific research. The importance of CGI to the film industry has led to the <strong>39</strong> \n                     <select id=\"q39_select\"><option value=\"\">...</option><option value=\"A\">A</option><option value=\"B\">B</option><option value=\"C\">C</option><option value=\"D\">D</option><option value=\"E\">E</option><option value=\"F\">F</option><option value=\"G\">G</option><option value=\"H\">H</option><option value=\"I\">I</option></select>\n                     of Marschner's model by special-effects studios. Marschner's model has led to the <strong>40</strong> \n                     <select id=\"q40_select\"><option value=\"\">...</option><option value=\"A\">A</option><option value=\"B\">B</option><option value=\"C\">C</option><option value=\"D\">D</option><option value=\"E\">E</option><option value=\"F\">F</option><option value=\"G\">G</option><option value=\"H\">H</option><option value=\"I\">I</option></select>\n                     of cinematography.\n                    </p>\n                </div>\n                <div class=\"word-bank\">\n                    <table>\n                        <tr>\n                            <td><strong>A</strong> light</td>\n                            <td><strong>B</strong> transparency</td>\n                            <td><strong>C</strong> age</td>\n                        </tr>\n                        <tr>\n                            <td><strong>D</strong> use</td>\n                            <td><strong>E</strong> astrophysics</td>\n                            <td><strong>F</strong> mathematics</td>\n                        </tr>\n                        <tr>\n                            <td><strong>G</strong> improvement</td>\n                            <td><strong>H</strong> colour</td>\n                            <td><strong>I</strong> translucency</td>\n                        </tr>\n                    </table>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "D",
