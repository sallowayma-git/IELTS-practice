(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q9-10-11-12-13-anchor\">\n                 <h4>Questions 22–26</h4>\n                <p>Complete the sentences below.</p>\n                <p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p>\n                <div class=\"sentence-completion\">\n                    <p><strong>22</strong> Some of the most severe floods for many centuries have recently occurred in parts of <input type=\"text\" id=\"q22_input\">.</p>\n                    <p><strong>23</strong> The Rhine and the <input type=\"text\" id=\"q23_input\"> river have experienced similar problems with water control.</p>\n                    <p><strong>24</strong> An area near Oxford will be flooded to protect the city of <input type=\"text\" id=\"q24_input\">.</p>\n                    <p><strong>25</strong> Planners who wish to allow water to pass more freely through city surfaces are called <input type=\"text\" id=\"q25_input\">.</p>\n                    <p><strong>26</strong> A proposal for part of the city of <input type=\"text\" id=\"q26_input\"> could show whether small-scale water projects could be applied on a large scale.</p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "F",
