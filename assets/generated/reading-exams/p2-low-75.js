(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q8-9-10-11-12-13-anchor\">\n                <h4>Questions 21–26</h4>\n                <p>Complete the sentences below.</p>\n                <p>Choose <strong>NO MORE THAN THREE WORDS</strong> from the passage for each answer.</p>\n                \n                <div class=\"sentence-completion-item\">\n                    <label for=\"q8\"><strong>21</strong> A small number of unusual cars are still produced by the <input type=\"text\" id=\"q8\"> method.</label>\n                </div>\n                <div class=\"sentence-completion-item\">\n                     <label for=\"q9\"><strong>22</strong> Lean production requires staff who are <input type=\"text\" id=\"q9\">.</label>\n                </div>\n                 <div class=\"sentence-completion-item\">\n                     <label for=\"q10\"><strong>23</strong> Lean production employs fewer people, and uses less <input type=\"text\" id=\"q10\">, equipment and time.</label>\n                </div>\n                 <div class=\"sentence-completion-item\">\n                     <label for=\"q11\"><strong>24</strong> Storage facilities are not needed if a procedure known as <input type=\"text\" id=\"q11\"> is implemented in the lean production method.</label>\n                </div>\n                 <div class=\"sentence-completion-item\">\n                     <label for=\"q12\"><strong>25</strong> Autonomation is a procedure for spotting any <input type=\"text\" id=\"q12\"> in the products on a production line.</label>\n                </div>\n                 <div class=\"sentence-completion-item\">\n                     <label for=\"q13\"><strong>26</strong> At Toyota factories, <input type=\"text\" id=\"q13\"> are suspended above manual production lines in order to show where production has to be halted.</label>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "ii",
