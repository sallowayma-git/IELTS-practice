(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q7-8-9-10-11-12-13-anchor\">\n                 <h4>Questions 33–39</h4>\n                <p>Complete the notes below.</p>\n                <p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p>\n                <div class=\"notes-completion\">\n                    <h5>People</h5>\n                    <ul>\n                        <li>sleep is vital for human survival</li>\n                        <li>biological advantages of sleep not clear – this makes it different from either <strong>33</strong> <input type=\"text\" id=\"q33_input\" maxlength=\"20\"> or <input type=\"text\" id=\"q33_input_2\" maxlength=\"20\"></li>\n                    </ul>\n                    <h5>Animals</h5>\n                    <ul>\n                        <li>aspects of sleep that most creatures share:\n                            <ul>\n                                <li>- lack of physical movement</li>\n                                <li>- reduced sensory awareness</li>\n                                <li>- sleep longer when they are <strong>34</strong> <input type=\"text\" id=\"q34_input\" maxlength=\"20\"></li>\n                            </ul>\n                        </li>\n                    </ul>\n                    <h5>Research</h5>\n                    <ul>\n                        <li>scientists once believed that <strong>35</strong> <input type=\"text\" id=\"q35_input\" maxlength=\"20\"> stopped during sleep – now know it takes place but not in a uniform way</li>\n                    </ul>\n                     <h5>Types of sleep – REM and NREM</h5>\n                    <ul>\n                        <li>primitive reptiles do not experience REM sleep</li>\n                        <li>now possible to prove that amount of NREM sleep rises with <strong>36</strong> <input type=\"text\" id=\"q36_input\" maxlength=\"20\"></li>\n                        <li>the metabolic rate and the <strong>37</strong> <input type=\"text\" id=\"q37_input\" maxlength=\"20\"> of the brain fall during NREM sleep</li>\n                    </ul>\n                    <h5>The Future</h5>\n                    <ul>\n                        <li>mysteries of REM sleep may become clearer as the <strong>38</strong> <input type=\"text\" id=\"q38_input\" maxlength=\"20\"> improve</li>\n                        <li>unlikely that a <strong>39</strong> <input type=\"text\" id=\"q39_input\" maxlength=\"20\"> will ever replace the need for sleep</li>\n                    </ul>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-3",
      "kind": "single_choice",
  ...
  "audit": {
    ...
    "matchConfidence": 0,
    "verifiedAt": "2026-03-08T16:24:30.820Z",
