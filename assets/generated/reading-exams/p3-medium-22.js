(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-12-13-anchor\">\n                <h4>Questions 37–39</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion\">\n                    <h4>The use of fire</h4>\n                    <p>\n                    Neanderthalers could not have survived without fire because the conditions they lived in were <strong>37</strong> <input type=\"text\" id=\"q37_input\">. Most evidence of purpose-built fires takes the form of ash piles, features of which suggest that the fires lasted a <strong>38</strong> <input type=\"text\" id=\"q38_input\"> time. It is hard to be certain about the size and structure of the fires, though they were certainly needed to protect the occupants from dangerous <strong>39</strong> <input type=\"text\" id=\"q39_input\">, among other things.\n                    </p>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-4",
      "kind": "single_choice",
  ...
  "audit": {
    "matchStatus": "matched",
    "matchConfidence": 1,
    "verifiedAt": "2026-03-08T16:24:30.548Z",
