(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q9-10-11-12-13-anchor\">\n                <h4>Questions 22–26</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                <div class=\"summary-text\">\n                    <h5>Humans in space – the Mars Outposts approach and its implications</h5>\n                    <p>\n                    One way of exploring space would be through collaboration between humans and robots. For example, when exploring the planet Mars, robots could be used to set up <strong>22</strong> <input type=\"text\" id=\"q22_input\"> and do initial research before humans arrive. In other cases, humans could stay in orbiting <strong>23</strong> <input type=\"text\" id=\"q23_input\"> and give orders to robots working on the surface of the planet. This would increase the speed of <strong>24</strong> <input type=\"text\" id=\"q24_input\"> with the robots.\n                    </p>\n                    <p>\n                    In such ways, robots might be used to work in space in commercial enterprises or <strong>25</strong> <input type=\"text\" id=\"q25_input\">. However, the final aim of humankind may be the <strong>26</strong> <input type=\"text\" id=\"q26_input\"> of space, and this could in turn change people's attitudes towards Earth.\n                    </p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "vi",
  ...
  "audit": {
    "matchStatus": "matched",
    "matchConfidence": 1,
    "verifiedAt": "2026-03-08T16:24:30.531Z",
