(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q10-11-12-13-14-anchor\">\n                 <h4>Questions 36–40</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>NO MORE THAN THREE WORDS AND/OR A NUMBER</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion\">\n                    <p>Once they had identified three types of defensive behaviour, Kalin and Shelton grouped the monkeys according to their <input type=\"text\" id=\"q36_input\">, in order to discover precisely when they were able to respond appropriately to different fear-related cues. They videotaped their results and found that monkeys as young as <input type=\"text\" id=\"q37_input\"> reacted to the cues but in a haphazard fashion. The researchers noted that they seemed to be unaware of the <input type=\"text\" id=\"q38_input\"> who were around them. Despite demonstrating <input type=\"text\" id=\"q39_input\">, the monkeys in the middle groups failed to react in ways corresponding to the experimental situation. The oldest group, however, reacted in the same way as <input type=\"text\" id=\"q40_input\">, and the researchers concluded that monkeys are capable of selective responding between nine and 12 weeks old.</p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "B",
