(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-12-13-anchor\">\n                <h4>Questions 24–26</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                \n                <div class=\"summary-completion\">\n                    <h4>The 'mix and match' strategy</h4>\n                    <p>\n                        One aspect of the Talbot Park project that some critics are concerned about is that the higher <strong>24</strong> <input type=\"text\" id=\"q24_input\"> of accommodation would lead to the old social problems returning. To prevent this, a team of various <strong>25</strong> <input type=\"text\" id=\"q25_input\"> worked on the project to ensure the buildings were not uniform. Further, they created pleasant, functional interiors that could still be built within their <strong>26</strong> <input type=\"text\" id=\"q26_input\">. Finally, the absence of walls means Talbot Park is characterised by openness, making it easier to regulate behaviour within the community.\n                    </p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "iv",
