(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q8-9-10-11-12-13-anchor\">\n                <h4>Questions 21–26</h4>\n                <p>Complete the sentences below.</p>\n                <p>Choose <strong>NO MORE THAN THREE WORDS</strong> from the passage for each answer.</p>\n                \n                <div class=\"completion-item\">\n                    <p><strong>21</strong> Philadelphia recovered from its <input type=\"text\" id=\"q8\"> when the temperature dropped dramatically.</p>\n                    <p><strong>22</strong> <input type=\"text\" id=\"q9\"> is an example of a small country whose economy is expanding.</p>\n                    <p><strong>23</strong> <input type=\"text\" id=\"q10\"> spread more slowly from Mexico than it did from the Middle East.</p>\n                    <p><strong>24</strong> Technology spread more quickly in <input type=\"text\" id=\"q11\"> than in Africa.</p>\n                    <p><strong>25</strong> <input type=\"text\" id=\"q12\"> is economically rich in spite of its tropical climate.</p>\n                    <p><strong>26</strong> Aid should be used to improve agriculture rather than to improve <input type=\"text\" id=\"q13\">.</p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "vi",
