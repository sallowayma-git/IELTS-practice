(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q5-6-7-8-anchor\">\n                <h4>Questions 5–8</h4>\n                <p>Complete the sentences below.</p>\n                <p>Choose <strong>NO MORE THAN THREE WORDS</strong> from the passage for each answer.</p>\n                <div class=\"question-item\">\n                    <div class=\"completion-item\">\n                        <span class=\"q-number\">5</span> These days, museum visitors tend to be referred to as <input type=\"text\" class=\"blank\" id=\"q5_input\">.\n                    </div>\n                </div>\n                <div class=\"question-item\">\n                    <div class=\"completion-item\">\n                        <span class=\"q-number\">6</span> Museum curators now need <input type=\"text\" class=\"blank\" id=\"q6_input\"> rather than academic qualifications.\n                    </div>\n                </div>\n                <div class=\"question-item\">\n                    <div class=\"completion-item\">\n                        <span class=\"q-number\">7</span> The linking of a range of public institutions that entertain the public is known as <input type=\"text\" class=\"blank\" id=\"q7_input\">.\n                    </div>\n                </div>\n                <div class=\"question-item\">\n                     <div class=\"completion-item\">\n                        <span class=\"q-number\">8</span> There is discussion about whether museums can be regarded in the same way as other <input type=\"text\" class=\"blank\" id=\"q8_input\">.\n                    </div>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-3",
      "kind": "multi_choice",
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-13-anchor\">\n                <h4>Questions 11–13</h4>\n                <p>Choose <strong>THREE</strong> letters, <strong>A–G</strong>.</p>\n                <p>Which <strong>THREE</strong> of the following are mentioned by the writer as disadvantages of blockbusters?</p>\n                 <div class=\"checkbox-options\">\n                    <label><input type=\"checkbox\" name=\"q11_13\" value=\"A\"> <strong>A</strong> They do not suit museum management styles.</label>\n                    <label><input type=\"checkbox\" name=\"q11_13\" value=\"B\"> <strong>B</strong> Specialist business advice has to be paid for.</label>\n                    <label><input type=\"checkbox\" name=\"q11_13\" value=\"C\"> <strong>C</strong> They involve an increased workload for personnel.</label>\n                    <label><input type=\"checkbox\" name=\"q11_13\" value=\"D\"> <strong>D</strong> They do not increase overall annual visitor numbers.</label>\n                    <label><input type=\"checkbox\" name=\"q11_13\" value=\"E\"> <strong>E</strong> They are very tiring to put on.</label>\n                    <label><input type=\"checkbox\" name=\"q11_13\" value=\"F\"> <strong>F</strong> What is popular in one country may not be popular in another.</label>\n                    <label><input type=\"checkbox\" name=\"q11_13\" value=\"G\"> <strong>G</strong> The content can be weakened through financial pressure.</label>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "C",
