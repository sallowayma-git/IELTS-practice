(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-12-13-anchor\">\n                <h4>Questions 24–26</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion\">\n                    <h5>Winners and losers</h5>\n                    <p>\n                    For youth soccer players, a key <strong>24</strong> <input type=\"text\" id=\"q24_input\"> is that they should always come away from the game with a positive attitude. In this respect, regardless of the effort the players make, they get some kind of <strong>25</strong> <input type=\"text\" id=\"q25_input\"> at the end of a game. In street soccer, however, players gain resilience because they have to learn to cope with failure. But the outcome of a match isn't remembered for long. In fact, no-one ever keeps a <strong>26</strong> <input type=\"text\" id=\"q26_input\"> of the results of games.\n                    </p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "E",
