  ...
  "questionGroups": [
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q1-2-anchor\">\n                <h4>Questions 27 and 28</h4>\n                <p>Choose <strong>TWO</strong> letters, A–F.</p>\n                <p>Which <strong>TWO</strong> of the following statements about the boys who took part in the study are made by the writer?</p>\n                <div class=\"checkbox-options\">\n                    <label><input name=\"q1_2\" type=\"checkbox\" value=\"A\"> A They had approximately the same number of friends.</label></div>\n                    <label><input name=\"q1_2\" type=\"checkbox\" value=\"B\"> B Some of their parents helped to set up the camp.</label></div>\n                    <label><input name=\"q1_2\" type=\"checkbox\" value=\"C\"> C They selected the group that they wanted to be in.</label></div>\n                    <label><input name=\"q1_2\" type=\"checkbox\" value=\"D\"> D They were responsible for bringing their own tents.</label></div>\n                    <label><input name=\"q1_2\" type=\"checkbox\" value=\"E\"> E They received clothes that identified the group they belonged to.</label></div>\n                    <label><input name=\"q1_2\" type=\"checkbox\" value=\"F\"> F Some of them were criticised for dropping litter.</label></div>\n                </div>\n            </div>",
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q13-14-anchor\">\n                <h4>Questions 39 and 40</h4>\n                <p>Choose <strong>TWO</strong> letters, A–F.</p>\n                <p>Which <strong>TWO</strong> of the following statements are true of the experimenters who ran the study?</p>\n                <div class=\"checkbox-options\">\n                    <label><input name=\"q13_14\" type=\"checkbox\" value=\"A\"> A They collected their data from secret observation posts.</label></div>\n                    <label><input name=\"q13_14\" type=\"checkbox\" value=\"B\"> B They encouraged the boys to use the terms ‘them' and 'us'.</label></div>\n                    <label><input name=\"q13_14\" type=\"checkbox\" value=\"C\"> C They used a rating exercise to assess the amount of in-group bias.</label></div>\n                    <label><input name=\"q13_14\" type=\"checkbox\" value=\"D\"> D They took steps to avoid personal injury among the boys.</label></div>\n                    <label><input name=\"q13_14\" type=\"checkbox\" value=\"E\"> E They secretly altered some of the results of the tournament.</label></div>\n                    <label><input name=\"q13_14\" type=\"checkbox\" value=\"F\"> F They joined in with the non-competitive activities.</label></div>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "A",
