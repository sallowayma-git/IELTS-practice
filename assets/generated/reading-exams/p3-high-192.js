(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q9-10-11-12-13-anchor\">\n                 <h4>Questions 35–39</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion\">\n                    <h4>Voynich Researchers</h4>\n                    <p>\n                    William Newbold believed that the author of the Voynich manuscript had been able to look at cells through a <strong>35</strong> <input type=\"text\" id=\"q35_input\">. Other researchers later demonstrated that there were flaws in his argument.\n                    </p>\n                    <p>\n                    William Friedman concluded that the manuscript was written in an artificial language that was based on <strong>36</strong> <input type=\"text\" id=\"q36_input\">. He couldn't find out the meaning of this language but he believed that the <strong>37</strong> <input type=\"text\" id=\"q37_input\"> would continue to bring advances in code-breaking.\n                    </p>\n                    <p>\n                    Dr Gabriel Landini used a system known as <strong>38</strong> <input type=\"text\" id=\"q38_input\"> in his research, and claims to have demonstrated the presence of genuine words.\n                    </p>\n                    <p>\n                    Dr Gordon Rugg's system involved a grille, that made it possible to quickly select symbols that appeared in a <strong>39</strong> <input type=\"text\" id=\"q39_input\">. Rugg's conclusion was that the manuscript lacked genuine meaning.\n                    </p>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-4",
      "kind": "single_choice",
  ...
  "audit": {
    "matchStatus": "matched",
    "matchConfidence": 1,
    "verifiedAt": "2026-03-08T16:24:30.826Z",
