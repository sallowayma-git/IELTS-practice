(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-12-13-anchor\">\n                 <h4>Questions 24–26</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion\">\n                    <h4>A Study of Insect Decision-making</h4>\n                    <p>\n                    A Bristol University study looked at how insects make decisions when their home has been <strong>24</strong> <input type=\"text\" id=\"q24_input\">. The ants in the experiment relied on the use of individuals called <strong>25</strong> <input type=\"text\" id=\"q25_input\"> to find a new nest and efficiently direct the others to go there. The study concluded that the effective implementation of the ants' decision meant that the insects could change homes quickly. The study emphasized the necessity, for people as well as insects, of having active <strong>26</strong> <input type=\"text\" id=\"q26_input\"> in order to execute decisions successfully.\n                    </p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "vii",
  ...
  "audit": {
    ...
    "matchConfidence": 0,
    "verifiedAt": "2026-03-08T16:24:30.610Z",
