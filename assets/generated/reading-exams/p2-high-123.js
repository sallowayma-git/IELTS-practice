(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q8-9-anchor\">\n                <h4>Questions 21 and 22</h4>\n                <p>Choose <strong>TWO</strong> letters, <strong>A-E</strong>.</p>\n                <p>According to the passage, which <strong>TWO</strong> of the following statements are true of migrating birds?</p>\n                <div class=\"question-item\">\n                     <div class=\"checkbox-options\">\n                        <label><input name=\"q8-9\" type=\"checkbox\" value=\"A\"> A. Many birds migrate longer distances than they need to.</label></div>\n                        <label><input name=\"q8-9\" type=\"checkbox\" value=\"B\"> B. Family groups migrate most successfully.</label></div>\n                        <label><input name=\"q8-9\" type=\"checkbox\" value=\"C\"> C. Birds need less water if they migrate at night.</label></div>\n                        <label><input name=\"q8-9\" type=\"checkbox\" value=\"D\"> D. Only shore birds are unaffected by wind.</label></div>\n                        <label><input name=\"q8-9\" type=\"checkbox\" value=\"E\"> E. Birds are unable to survive if separated from other members of their own species.</label></div>\n                    </div>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-3",
