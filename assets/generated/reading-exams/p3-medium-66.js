(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q9-10-11-12-13-14-anchor\">\n                <h4>Complete the notes below.</h4>\n                <p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p>\n                \n                <div class=\"notes-completion\">\n                    <h4>Mercator's Projection</h4>\n                    <ul>\n                        <li>His attempt to represent the globe as a <strong>35</strong> <input type=\"text\" id=\"q35_input\" maxlength=\"25\"> map</li>\n                    </ul>\n                    <p><strong>Problem:</strong></p>\n                    <ul>\n                        <li>When sailors used a map based on lines of latitude and longitude and kept to a constant compass bearing, the course of the ship could not be shown as a <strong>36</strong> <input type=\"text\" id=\"q36_input\" maxlength=\"25\"> on a map</li>\n                    </ul>\n                    <p><strong>Solution:</strong></p>\n                    <ul>\n                         <li>To increase the space separating the lines of latitude, the further they are from the equator</li>\n                    </ul>\n                    <p><strong>Result:</strong></p>\n                    <ul>\n                         <li>When Mercator straightened the ‘rhumbs’ as intended, this produced <strong>37</strong> <input type=\"text\" id=\"q37_input\" maxlength=\"25\"> at the northern and southern extremities, with the full width of the map being taken up by the <strong>38</strong> <input type=\"text\" id=\"q38_input\" maxlength=\"25\"></li>\n                    </ul>\n                     <p><strong>Original intention:</strong></p>\n                    <ul>\n                         <li>Mercator originally designed the map for <strong>39</strong> <input type=\"text\" id=\"q39_input\" maxlength=\"25\"> purposes</li>\n                    </ul>\n                     <p><strong>Uses of Mercator's Projection up to the present day:</strong></p>\n                    <ul>\n                         <li>Various uses including the mapping of <strong>40</strong> <input type=\"text\" id=\"q40_input\" maxlength=\"25\"> by state cartographers</li>\n                         <li>Also used to portray planets in our solar system on the web</li>\n                    </ul>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "TRUE",
