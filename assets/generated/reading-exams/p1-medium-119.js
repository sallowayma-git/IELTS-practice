(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q7-8-9-10-11-12-13-anchor\">\n                <h4>Questions 7–13</h4>\n                <p>Answer the questions below.</p>\n                <p>Choose <strong>NO MORE THAN TWO WORDS AND/OR A NUMBER</strong> from the passage for each answer.</p>\n                \n                <div class=\"question-item\">\n                    <p><strong>7</strong> Apart from exchange rates, which factor has had a negative impact on New Zealand's forestry exports?<input type=\"text\" id=\"q7_input\"></p>\n                </div>\n                <div class=\"question-item\">\n                    <p><strong>8</strong> Which part of New Zealand's economy does the forestry industry rank third in?<input type=\"text\" id=\"q8_input\"></p>\n                </div>\n                 <div class=\"question-item\">\n                    <p><strong>9</strong> According to the New Zealand forestry industry, what could be the size of its workforce by 2025?<input type=\"text\" id=\"q9_input\"></p>\n                </div>\n                 <div class=\"question-item\">\n                    <p><strong>10</strong> What kind of timber product is available in large amounts from renewable forests in New Zealand?<input type=\"text\" id=\"q10_input\"></p>\n                </div>\n                 <div class=\"question-item\">\n                    <p><strong>11</strong> Which aspect of timber production are New Zealand's main customers increasingly concerned about?<input type=\"text\" id=\"q11_input\"></p>\n                </div>\n                 <div class=\"question-item\">\n                    <p><strong>12</strong> Outside the Southern Hemisphere, who are New Zealand forestry's main competitors?<input type=\"text\" id=\"q12_input\"></p>\n                </div>\n                 <div class=\"question-item\">\n                    <p><strong>13</strong> Which group of products is New Zealand's forestry industry now having to compete with?<input type=\"text\" id=\"q13_input\"></p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "FALSE",
