(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q4-5-6-7-8-anchor\">\n                <h4>Questions 17–21</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p>\n                <div class=\"summary-completion-box\">\n                    <h4>History of roller coasters</h4>\n                    <ul>\n                        <li>Modern roller coasters are descended from 16th-century Russian slides with a surface of <strong>17</strong> <input type=\"text\" id=\"q17_input\">.</li>\n                        <li>In France, because of the higher temperatures, the wooden surface on the slides was <strong>18</strong> <input type=\"text\" id=\"q18_input\">, and <strong>19</strong> <input type=\"text\" id=\"q19_input\"> were attached to the cars to ease the descent.</li>\n                        <li>The first US roller coaster was used for transporting <strong>20</strong> <input type=\"text\" id=\"q20_input\"> down a mountainside in carts.</li>\n                        <li>Initially, these were pulled by mules, but in time power was produced by <strong>21</strong> <input type=\"text\" id=\"q21_input\">.</li>\n                    </ul>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-3",
