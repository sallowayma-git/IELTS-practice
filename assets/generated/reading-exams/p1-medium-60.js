(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q8-9-10-11-12-13-anchor\">\n                <h4>Complete the notes below.</h4>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                \n                <div class=\"notes-completion\">\n                    <h4>The challenges for prosopagnosia researchers</h4>\n                    <p><strong>Differences in prosopagnosics</strong></p>\n                    <ul>\n                        <li>As well as being unable to recognise facial features, prosopagnosics may also have problems recognising commonly seen <strong>8</strong> <input type=\"text\" id=\"q8_input\" maxlength=\"20\"> and objects.</li>\n                        <li>Some also have problems recognizing the <strong>9</strong> <input type=\"text\" id=\"q9_input\" maxlength=\"20\"> on someone else's face.</li>\n                        <li>Some prosopagnosics can recognise that people are regarded as attractive by others.</li>\n                    </ul>\n                    <p><strong>Causes of prosopagnosia</strong></p>\n                    <ul>\n                         <li>Prosopagnosia may be caused by just one <strong>10</strong> <input type=\"text\" id=\"q10_input\" maxlength=\"20\">, according to Martina Gruter.</li>\n                         <li>It may also be caused by a defect in the <strong>11</strong> <input type=\"text\" id=\"q11_input\" maxlength=\"20\"> eye, according to Brad Duchaine.</li>\n                    </ul>\n                    <p><strong>Treatment for prosopagnosia</strong></p>\n                    <ul>\n                         <li>Joseph DeGutis's patient proved he had been successfully trained to recognise faces inside the <strong>12</strong> <input type=\"text\" id=\"q12_input\" maxlength=\"20\"> and in the outside world.</li>\n                         <li>Duchaine's training may allow prosopagnosics to recognise faces belonging to family and workmates.</li>\n                         <li>Thomas Gruter doubts that the training will work and mentions that <strong>13</strong> <input type=\"text\" id=\"q13_input\" maxlength=\"20\"> by some subjects can affect research results.</li>\n                    </ul>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "FALSE",
