(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q10-11-12-13-14-anchor\">\n                 <h4>Questions 36–40</h4>\n                <p>Complete each sentence with the correct ending, <strong>A–G</strong>, below.</p>\n                <ul class=\"sentence-ending-options\">\n                    <li>the museum programme will lose its individuality.</li>\n                    <li>the museum will lose credibility.</li>\n                    <li>the art loses its importance.</li>\n                    <li>it will have to balance opposing demands.</li>\n                    <li>this will encourage museum visitors in the future.</li>\n                    <li>it will have the capability of increasing revenue.</li>\n                    <li>the architect's reputation might suffer.</li>\n                </ul>\n\n                <div class=\"question-item\"><strong>36</strong> If a large space is available in the museum, <input type=\"text\" id=\"q36_input\" maxlength=\"1\"></div>\n                <div class=\"question-item\"><strong>37</strong> If children are allowed to move freely in parts of the gallery, <input type=\"text\" id=\"q37_input\" maxlength=\"1\"></div>\n                <div class=\"question-item\"><strong>38</strong> If too much emphasis is placed on the museum building itself, <input type=\"text\" id=\"q38_input\" maxlength=\"1\"></div>\n                <div class=\"question-item\"><strong>39</strong> If there is an over-reliance on 'blockbuster' exhibitions, <input type=\"text\" id=\"q39_input\" maxlength=\"1\"></div>\n                <div class=\"question-item\"><strong>40</strong> If the NGV wants to continue to be successful, <input type=\"text\" id=\"q40_input\" maxlength=\"1\"></div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "C",
