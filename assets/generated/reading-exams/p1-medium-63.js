(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q6-7-8-9-10-11-12-13-anchor\">\n                <h4>Complete the notes below.</h4>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                \n                <div class=\"notes-completion\">\n                    <h4>The Development of Agriculture and Food Preservation</h4>\n                    <p><strong>The changes agriculture brought about were:</strong></p>\n                    <ul>\n                        <li>the development of equipment and larger <strong>6</strong> <input type=\"text\" id=\"q6_input\" maxlength=\"20\"></li>\n                        <li>the ability to keep <strong>7</strong> <input type=\"text\" id=\"q7_input\" maxlength=\"20\"> as writing developed</li>\n                        <li>the setting up of organised government</li>\n                    </ul>\n                    <p><strong>Food preservation</strong></p>\n                    <ul>\n                         <li>early methods of food preservation included: smoking, drying and combining food with acid or <strong>8</strong> <input type=\"text\" id=\"q8_input\" maxlength=\"20\"></li>\n                         <li>canning\n                            <ul>\n                                <li>Nicolas Appert put food into containers made of <strong>9</strong> <input type=\"text\" id=\"q9_input\" maxlength=\"20\"></li>\n                                <li>Appert's method resulted in preserved food that had the same taste and <strong>10</strong> <input type=\"text\" id=\"q10_input\" maxlength=\"20\"> as fresh food</li>\n                                <li>Peter Durand introduced cans which had the advantage of being <strong>11</strong> <input type=\"text\" id=\"q11_input\" maxlength=\"20\"> and hard to break</li>\n                                <li>In 1855, the metal can opener replaced the <strong>12</strong> <input type=\"text\" id=\"q12_input\" maxlength=\"20\"> which had been used with a hammer to open cans</li>\n                                <li>some food was still found to be edible after more than a hundred years, e.g. an old can of <strong>13</strong> <input type=\"text\" id=\"q13_input\" maxlength=\"20\"></li>\n                            </ul>\n                         </li>\n                         <li>freezing</li>\n                    </ul>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "FALSE",
