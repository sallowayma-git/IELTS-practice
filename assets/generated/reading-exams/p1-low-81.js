(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q6-7-8-9-anchor\">\n                <p>Complete the notes below.</p>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                <div class=\"notes-completion\">\n                    <h4>The production of rock salt</h4>\n                    <ul>\n                        <li>samples of the salt are collected with the aid of a drill</li>\n                        <li>the salt is analysed to see if mining should go ahead</li>\n                        <li>vertical tunnels are sunk into the middle of the salt deposit</li>\n                        <li>during a process called <strong>6</strong> <input type=\"text\" id=\"q6_input\">, a machine is used to break into the salt</li>\n                        <li>explosives are placed in the holes in the salt</li>\n                        <li>after blasting, <strong>7</strong> <input type=\"text\" id=\"q7_input\"> of salt are left behind to hold the roof up</li>\n                        <li>in an underground crushing area, small pieces of rock salt are gathered using a <strong>8</strong> <input type=\"text\" id=\"q8_input\"></li>\n                        <li>the process of <strong>9</strong> <input type=\"text\" id=\"q9_input\"> removes any unwanted material from the rock salt</li>\n                    </ul>\n                </div>\n            </div>"
    },
    {
      "groupId": "group-3",
      ...
      "bodyHtml": "<div class=\"group\" id=\"q10-11-12-13-anchor\">\n                 <p>Complete the flow-chart below.</p>\n                 <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                 <div class=\"flow-chart\">\n                    <h4>Obtaining salt from brine: the multi-effect vacuum evaporator</h4>\n                    <div class=\"flow-item\">\n                        cylinders made of <strong>10</strong> <input type=\"text\" id=\"q10_input\"> are filled with brine\n                    </div>\n                    <div class=\"flow-arrow\">↓</div>\n                    <div class=\"flow-item\">\n                        <strong>11</strong> <input type=\"text\" id=\"q11_input\"> heats the tube in the first cylinder\n                    </div>\n                    <div class=\"flow-arrow\">↓</div>\n                    <div class=\"flow-item\">\n                        the <strong>12</strong> <input type=\"text\" id=\"q12_input\"> in the cylinders falls due to condensation\n                    </div>\n                    <div class=\"flow-arrow\">↓</div>\n                    <div class=\"flow-item\">\n                        slurry collects in the cylinders and passes to a tank\n                    </div>\n                    <div class=\"flow-arrow\">↓</div>\n                     <div class=\"flow-item\">\n                        <strong>13</strong> <input type=\"text\" id=\"q13_input\"> are used to separate salt particles by size\n                    </div>\n                 </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "TRUE",
