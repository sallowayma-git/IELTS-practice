(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q1-2-3-4-5-6-7-anchor\">\n                <h4>Questions 14–20</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>NO MORE THAN TWO WORDS</strong> from the passage for each answer.</p>\n                \n                <div class=\"summary-completion\">\n                    <p>\n                    Three theories have been put forward to explain the disappearance of the different species of large mammals that inhabited <strong>14</strong> <input type=\"text\" id=\"q14_input\"> 11,000 years ago. The <strong>15</strong> <input type=\"text\" id=\"q15_input\">, proposed around fifty years ago by Paul S. Martin, blames <strong>16</strong> <input type=\"text\" id=\"q16_input\"> by people for mass extinction. Computer calculations seem to support this explanation, but critics question the reliability of the figures they are based on.\n                    </p>\n                    <p>\n                    The second theory suggests that humans introduced a <strong>17</strong> <input type=\"text\" id=\"q17_input\"> which wiped out the large mammals. However, so far this theory also lacks any <strong>18</strong> <input type=\"text\" id=\"q18_input\">.\n                    </p>\n                    <p>\n                    The final theory suggests that this period experienced significant <strong>19</strong> <input type=\"text\" id=\"q19_input\">, which eventually led to the loss of habitat and to the division of the <strong>20</strong> <input type=\"text\" id=\"q20_input\"> that some of the large mammals had organized.\n                    </p>\n                </div>\n            </div>",
  ...
  "audit": {
    "matchStatus": "matched",
    "matchConfidence": 1,
    "verifiedAt": "2026-03-08T16:24:30.644Z",
