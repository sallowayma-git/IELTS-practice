(function registerReadingExamData(global) {
  ...
  "questionGroups": [
    ...
    },
    {
      ...
      "bodyHtml": "<div class=\"group\" id=\"q11-12-13-anchor\">\n                <h4>Questions 24–26</h4>\n                <p>Complete the summary below.</p>\n                <p>Choose <strong>ONE WORD ONLY</strong> from the passage for each answer.</p>\n                \n                <div class=\"summary-completion\">\n                    <h4>Celebrities achieve a global status</h4>\n                    <p>The development of the publishing industry in the 1700s signalled the beginning of international fame. A growing number of people could read, which meant they had the chance to become informed about their favourite figures by reading <strong>24</strong> <input type=\"text\" id=\"q24_input\">. This exposure to celebrities expanded further when radio and television became popular, and it was mass media attention that resulted in higher status and fame for some celebrities. The recent rise of reality television has also meant that a person's <strong>25</strong> <input type=\"text\" id=\"q25_input\"> rather than their talent can bring fame. With this type of television programme, fame may be entirely dependent on the response of the <strong>26</strong> <input type=\"text\" id=\"q26_input\">.</p>\n                </div>\n            </div>"
    }
  ],
  "answerKey": {
    "q1": "x",
  ...
  "audit": {
    "matchStatus": "matched",
    "matchConfidence": 1,
    "verifiedAt": "2026-03-08T16:24:30.525Z",
