(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "1983年，植物学家杰克·舒尔茨和伊恩·鲍德温报告称，年轻的枫树叶片在暴露于被植食性（食草）昆虫损伤的枫树附近时，其防御系统会增强。他们认为，受损的树木是通过向空气中释放化学信号来警示邻居天敌的存在。但植物研究界并不接受这一观点。批评者指出，这些结果难以重复。许多人还质疑，如果这种行为只利于邻近植物而不利于释放信号的植物本身，它在进化上如何能稳定存在。到20世纪80年代末，大多数生态学家认为舒尔茨和鲍德温的观点已经被否定。"
    },
    {
      "label": "Paragraph B",
      "text": "然而，十年后，一些设计更为严谨的实验开始产生令人信服的相反证据。2000年，进化生态学家理查德·卡班证明，当野生烟草植物种植在被切割损伤的山艾树附近时，它们会对食草动物产生抗性。这种变化似乎是对山艾树释放的化学物质——即挥发性有机化合物（VOCs）——的反应。其他研究人员很快在包括利马豆、蚕豆、大麦和玉米在内的多种植物中报告了类似的由VOC诱导的防御反应。2006年，卡班证明，受损山艾树释放的VOCs能在距离60厘米以内的植物中诱导食草抗性，这完全在自然界中山艾树邻居的范围之内。"
    },
    {
      "label": "Paragraph C",
      "text": "但问题仍然存在：“植物为什么要在一个对自己没有明显好处的功能上浪费宝贵的资源？”一种假说认为，外部交流通道仅仅是植物内部信号传递的延伸。在山艾树、利马豆和杨树中，从植物受损部位释放的VOCs会在同一植物的完好部位引发抗性反应，这表明每个植物个体都利用这些信号来协调自身的生理反应以保护自己。卡班对此表示赞同，他说：“我们看到的植物间信号传递，可能是植物借用（内部信号传递）这一过程的结果。”另一种可能是，植物之间的VOC信号传递之所以被保留下来，是因为它通过帮助同种亲缘植物，增强了信号发送者的“扩展适应度”——这种策略被称为亲缘选择。"
    },
    {
      "label": "Paragraph D",
      "text": "在过去几年中，以色列内盖夫本-古里安大学的阿里尔·诺沃普兰斯基领导的团队似乎已经找到了求救信号可以通过植物根部传递的证据。他们将豌豆排成行种植，并使每行中的第一株植物处于类似干旱的条件下。然后，他们通过测量叶片上的微小孔洞（即气孔）来评估植物的反应，这些气孔在缺水时会关闭。十五分钟后，受胁迫的植物被观察到正在关闭气孔，随后所有邻居植物也一个接一个地关闭了气孔。重要的是，在一个阻止相邻植物根部接触的对照实验中，气孔保持开放。与此同时，苏格兰阿伯丁大学的大卫·约翰逊的团队一直在研究大多数植物根部周围出现的毛发状真菌迷宫。这些真菌参与了一种重要的双向关系：它们以换取糖分的方式为植物提供急需的磷和氮。一项让蚕豆植物遭受蚜虫（一种小型食草昆虫）侵害的研究表明，这些网络还可以作为警告邻近植物虫害来袭的通道。"
    },
    {
      "label": "Paragraph E",
      "text": "西澳大利亚大学的莫妮卡·加利亚诺认为，植物甚至可能利用声音来警示邻居。在一项研究中，她证明生长在茴香旁边的辣椒植物比与其他辣椒植物一起生长的幼苗发育得更快。加利亚诺和她的同事怀疑，辣椒植物是在补偿茴香的存在——已知茴香会释放抑制其他植物生长的化学物质。然而，值得注意的是，当植物交流通道——空气中的挥发物、根部接触和共同的真菌网络——被阻断后，实验结果需要另一种解释。“我们认为这个其他交流通道可能是声音，”加利亚诺说。但荷兰莱顿大学的行为生态学家卡雷尔·滕卡特指出，要利用这种好处，需要植物体内尚未被描述的感知机制。尽管存在广泛的质疑，加利亚诺还是得到了一些鼓励。例如，理查德·卡班持谨慎乐观的态度。他说：“不管她支持的解释是否正确，我认为她得出的结果是我们作为一个领域需要认真面对的。”"
    },
    {
      "label": "Paragraph F",
      "text": "研究人员认为，对这一现象的认识最终可以应用于农业，并带来更强健作物的培育。但所有人都同意，还有大量工作要做。约翰逊说：“将我们（对植物交流机制的）有限认识应用于农业是一个巨大的跨越，但这一天肯定在视野之内。”尽管如此，从研究这一植物互动新领域的学者中已经清晰地传出了一个信息：尽管没有眼睛、耳朵或神经系统，植物绝非不善交流。阿里尔·诺沃普兰斯基回忆道：“我在20世纪80年代末开始读博士时，所有这些都被认为非常奇怪。如今，这一点已毫无疑问。我们现在认识到，植物能够与其他植物进行非常复杂的信息交换。这个想法不再奇怪了。”"
    }
  ],
