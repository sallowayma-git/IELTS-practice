(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "段落 1",
      "text": "A段\n大多数社会科学家顽固地抵制动物拥有文化这一观点。即使像鲸鱼和海豚这样高级的鲸类哺乳动物，显然也没有艺术、文学或建筑。但是，多年来的耐心观察已开始揭示出一些只能从其他鲸鱼那里学到的行为。鲸类生物学家说，这就构成了文化。\nB段\n到目前为止，座头鲸和虎鲸提供了鲸类拥有文化的最佳证据，而雄性座头鲸的歌声是最引人注目的例子之一。不同海洋中的座头鲸种群唱着不同的歌，但在同一个海洋中，它们都坚持唱同一首歌。然而，在繁殖季节，声音会发生变化，因为雌性似乎被新颖的歌声所吸引。一只雄性可能会增加一组额外的呻吟声；另一只可能会去掉一系列的咕噜声。很快，所有其他雄性都改变了自己的演绎以包含这些变化，直到它们再次唱着同一首歌。由于这种情况发生在分布在地球广大区域的数千头鲸鱼之间，这种变化不可能是对动物环境中任何因素的反应。这首歌的最新版本只能从其他鲸鱼那里学到——几乎可以肯定是通过模仿。\nC段\n文化在虎鲸的生活中扮演着更重要的角色。这一点在美洲西北沿岸最为明显，那里的虎鲸分为两个截然不同的种群——“定居型”和“过客型”。它们生活在同一片水域，但不混居。实际上，它们属于两种完全不同的文化。定居型生活在稳定的群体或“豆荚”（pods）中，由两到三位母亲及其后代组成——总共大约20头鲸鱼。幼崽在整个成年期都和母亲呆在一起，在多年的观察中，从未有人见过一头鲸鱼转换豆荚。过客型则以三到六只为一组，组成更小、更多变的群体。\nD段\n过客型和定居型社会之间最明显的区别之一是它们传递信息的方式。虎鲸通过一系列回声定位的咔嗒声来探测猎物，但用吱吱声、口哨声和哀鸣声的词汇进行交谈。过客型只有几种这样的叫声，而且所有过客型社会都共享相同的叫声。定居型拥有更广泛的曲目，每个家庭组都有自己独特且与众不同的叫声集。尽管它们之间经常互动，每个定居型豆荚都坚定地坚持自己的方言。研究表明，这些方言至少保持了40年。\nE段\n要有资格成为虎鲸文化的一部分，方言必须是从豆荚的其他成员那里学来的。拥有不同方言的动物共享同一片水域，因此这种变异不可能是物理环境的产物。“我们可以抛弃方言是遗传的这一观念，”不列颠哥伦比亚大学的兰斯·巴雷特-伦纳德说。他花了过去七年时间分析了270头鲸鱼的DNA。他的亲子鉴定显示，雌性虎鲸总是吸引来自自己豆荚之外的配偶——那些拥有非常不同方言的雄性。如果方言是由基因编程的，父亲和母亲的叫声模式都会传给幼崽。“幼崽非常精确地使用其母系豆荚的叫声。没有来自父亲的输入，”巴雷特-伦纳德说。\nF段\n问题仍然存在——这是文化吗？根据亚特兰大埃默里大学的弗兰斯·德·瓦尔的说法，它是。他认为文化只是在许多生物中进化出来的另一种生物适应。以这种方式看待文化的一个好处是，你可以开始理解它是如何以及为什么在这些生物中产生的。鲸鱼拥有几个赋予它们社会学习优势的生物属性。除了它们先进的心智能力外，它们还擅长识别声音：这是在海洋环境中交流的理想选择。许多物种花费数年时间抚养后代，并且生活在小型、稳定的多代社会中，这种社会系统为教学和学习提供了充足的机会。\nG段\n但是，为什么鲸类进化出了向其他群体成员学习的能力？鲸类生物学专家认为，生态因素和适应环境突然变化的需求在文化的出现中起了很大作用。虽然海洋在许多方面是一个相对稳定的栖息地，但在一个关键方面却是高度可变的——食物的可用性。前一刻可能还有丰富的鱼类供应，下一刻它们就消失了。当这种情况发生时，群体中年长成员的过去经验——以及分享这一知识的能力——是一笔巨大的资产。虎鲸的方言允许群体成员彼此识别，使它们能够分享关于食物热点的信息。在定居型虎鲸中，这也允许雌性通过从豆荚外挑选一个方言陌生的配偶来避免近亲繁殖，巴雷特-伦纳德说。\nH段\n分享信息的重要性似乎导致了至少某些鲸鱼物种的生物学变化。雌性虎鲸，像人类一样，非常不寻常，因为它们在有了后代后还能生活长达四分之一个世纪。而鲸鱼女族长提供的最重要的东西就是——文化知识，这对群体的生存至关重要，直接从一代传给下一代。"
    }
  ],
