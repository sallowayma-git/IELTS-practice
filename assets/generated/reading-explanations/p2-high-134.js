(function registerReadingExplanationData(global) {
  ...
  "passageNotes": [
    {
      "label": "Paragraph 1-5（How they move）",
      "text": "过山车由多节车厢组成，沿轨道运行，但无自带引擎 —— 多数行程依赖惯性和重力，仅起步时需能量将车厢拉上提升坡。传统提升装置是轨道下的环形链条，由底部电机驱动齿轮带动，车厢紧扣链条被拉至坡顶后释放下滑。初始爬坡的目的是积累势能（高度越高，重力做功距离越长），下滑时势能转化为动能加速，谷底动能最大，推动车厢冲上第二个坡再次积累势能。轨道设计通过动能与势能的持续转化产生加速变化，这正是过山车的乐趣所在，本质是利用重力和惯性的轨道机器。"
    },
    {
      "label": "Paragraph 6-12（Coasting through history）",
      "text": "过山车历史悠久，直接前身是 16-17 世纪俄罗斯的冰滑梯 —— 木质滑道覆冰，游客爬至 21 米高的滑道顶端，乘坐木制或冰制雪橇下滑，底部撞入沙堆停止。后传入法国，因气候温暖，冰滑梯被改为蜡面滑道，为助力雪橇下滑加装轮子，1817 年首次出现带轨道的列车，法国还设计出多车厢、多弯道的复杂轨道。19 世纪中期，美国宾夕法尼亚山区建造首座过山车，最初用于将煤炭运至 29 公里外的铁路，空车由骡子拉回山顶，后改用蒸汽机提升效率。铁路公司新建隧道后，该轨道闲置，被改造为 “观光项目”，游客花 1 美元可悠闲上山、颠簸下山，大获成功。此后观光过山车与现代木质过山车在全美游乐园流行，20 世纪 20 年代全美约有 2000 座过山车。大萧条后过山车建设减少，1970-80 年代第二次热潮推出管状钢过山车，80 年代后期兴趣下降，1990 年代至今第三次热潮中，新技术（如新型发射装置）让过山车设计更多样，未来将出现更快、更高、更复杂的过山车。"
    }
  ],
  "questionExplanations": [
    {
      "sectionTitle": "1. 图表填空（Questions 14–16：ONE WORD ONLY）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 14,
    ...
    },
    {
      ...
      "text": "题目翻译：现代过山车起源于 16 世纪俄罗斯表面为_\\___\\__的滑梯。\n答案：ice（冰）\n解析：定位 Paragraph 6 中 “Their direct ancestors were ice slides, popular in Russia in the 16th and 17th centuries. They consisted of a long, steep, wooden slide covered in ice”，明确提到表面为 “冰”，因此答案为 “ice”。\n题目翻译：在法国，因温度较高，滑梯的木质表面被_\\___\\__。\n答案：waxed（涂蜡）\n解析：定位 Paragraph 7 中 “the warmer climate would melt the ice, so the French started building waxed slides instead”，明确提到表面 “涂蜡”，因此答案为 “waxed”。\n题目翻译：车厢上加装_\\___\\__以助力下滑。\n答案：wheels（轮子）\n解析：定位 Paragraph 7 中 “To help the sleds move down these slides, they added wheels”，明确提到加装 “轮子”，因此答案为 “wheels”。\n题目翻译：美国首座过山车最初用于用车厢将_\\___\\__运下山。\n答案：coal（煤炭）\n解析：定位 Paragraph 8 中 “the first American roller coaster was built... originally to provide an easy way to send coal to the railway 29 km down the mountain”，明确提到运输 “煤炭”，因此答案为 “coal”。\n题目翻译：起初由骡子拉动，后来动力由_\\___\\__提供。\n答案：steam engines（蒸汽机）\n解析：定位 Paragraph 8 中 “They were eventually replaced with steam engines to make the system more efficient”，明确提到 “蒸汽机”，因此答案为 “steam engines”。"
    },
    {
      "sectionTitle": "3. 判断题（Questions 22–26：TRUE/FALSE/NOT GIVEN）",
      "mode": "per_question",
      "items": [
        {
          "questionNumber": 22,
