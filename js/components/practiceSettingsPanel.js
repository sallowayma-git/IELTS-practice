...
(function (global) {
    ...
    function buildModalMarkup() {
        return [
            ...
            '                            </div>',
            '                            <button class="btn data-mgmt-btn practice-timer-save" type="button" data-timer-save>保存阅读设置</button>',
            '                        </section>',
            ...
            '                                <label class="practice-timer-field"><span>到时处理</span><select data-timer-field="expiryAction"><option value="warn">仅提醒</option><option value="auto-submit">自动提交</option><option value="lock">锁定答案</option></select></label>',
            '                            </div>',
            '                            <button class="btn data-mgmt-btn practice-timer-save" type="button" data-timer-save>保存听力设置</button>',
            '                        </section>',
            '                    </div>',
            '                </div>',
